...
HardwareSerial demo_uart(1);
static DemoUartProtocol demo_uart_protocol(demo_uart);
static DemoUartProtocol *demo_uart_protocol_p = &demo_uart_protocol;
...
RootTask root_task(0, &config, motor_task, display_task_p, wifi_task_p,
                   ...
                   serial_protocol_protobuf_p, demo_uart_protocol_p);
...
void setup()
{
    ...
    demo_uart_protocol.begin(DEMO_UART_BAUD, DEMO_UART_RX_PIN, DEMO_UART_TX_PIN);
